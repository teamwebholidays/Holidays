...
<header class="container-fluid">
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      <div class="col-lg-3 col-md-5 col-8 logo-img"><a class="navbar-brand" href="<?php echo $path?>"><img src="<?php echo $path?>public/images/logo-vinatrip.png" class="img-fluid" width="70%"/></a></div>
