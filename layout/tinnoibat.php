				  ...
				  <div class="card-body" style="background-color: rgb(172,214,60); color: white">
				    <h3 class="card-title">5.500.000 <sup>VNĐ</sup></h3>
				     <p class="card-text" style="color:#343434">
				     	<img src="public/images/icon-back-logo/icon-clock.png" width="20em" title="icon-clock">&nbsp 4 Ngày &nbsp
				     	<img src="public/images/icon-back-logo/icon-lich.png" width="20em" title="icon-lich">&nbsp Liên hệ</p>
				 ...
				 <div>
				  ...
				  <div class="card-body" style="background-color: rgb(172,214,60); color: white;">
				    <h3 class="card-title">500.000 <sup>VNĐ</sup></h3>
				     <p class="card-text" style="color:#343434">
				     	<img src="public/images/icon-back-logo/icon-clock.png" width="20em" title="icon-clock">&nbsp 1 Ngày &nbsp
				     	<img src="public/images/icon-back-logo/icon-lich.png" width="20em" title="icon-lich">&nbsp Hằng ngày</p>
